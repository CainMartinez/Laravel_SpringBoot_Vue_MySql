...
INSERT INTO `Customer` (`customer_id`, `customer_uuid`, `first_name`, `last_name`, `age`, `address`, `email`, `phone_number`, `password`, `avatar_url`, `bio`, `has_coupon`, `loyalty_points`, `is_active`, `refresh_token`, `created_at`, `updated_at`) VALUES
(21, '394e3a53-3c2c-4132-9b10-4a757a4efac4', 'Yolanda', 'Yolanda', NULL, NULL, 'yomogan@gmail.com', NULL, '$argon2id$v=19$m=4096,t=3,p=1$LlZawwwdCHzz1ztxqNBNQg$eXlXClwlNahzjzpE8iP8GWOcY2tcohFIPZstJ0HHm1Q', 'https://i.pravatar.cc/150?u=Yolanda', NULL, 0, 0, 1, NULL, '2024-12-11 22:38:47', '2024-12-11 22:38:47');
...
(1, '0abbb126-a39b-11ef-a437-0242ac140002', 'Jardín de los Cerezos', 'Jardin_de_los_Cerezos_781230', 'Una sala inspirada en los paisajes japoneses, con decoración de cerezos en flor y detalles tradicionales.', 'Japón', 50, 0, 0.00, '/src/assets/rooms/japan.webp', 1, '2024-11-15 21:46:16', '2024-11-15 21:46:16', 1),
(2, '0abbbfde-a39b-11ef-a437-0242ac140002', 'Palacio de los Maharajás', 'Palacio_de_los_Maharajas_871237', 'Una sala con elementos decorativos indios, desde alfombras hasta lámparas tradicionales.', 'India', 60, 0, 0.00, '/src/assets/rooms/india.webp', 1, '2024-11-15 21:46:16', '2024-11-15 21:46:16', 2),
(3, '0abbc1b6-a39b-11ef-a437-0242ac140002', 'Taberna Española', 'Taberna_Espanola_612342', 'Un espacio acogedor con motivos tradicionales españoles, como azulejos y jamones colgados.', 'España', 40, 0, 0.00, '/src/assets/rooms/spain.webp', 1, '2024-11-15 21:46:16', '2024-11-15 21:46:16', 3),
(4, '0abbc27b-a39b-11ef-a437-0242ac140002', 'Villa Toscana', 'Villa_Toscana_891243', 'Sala que evoca la tranquilidad y belleza de los viñedos italianos, con una decoración elegante.', 'Italia', 70, 0, 0.00, '/src/assets/rooms/italy.webp', 1, '2024-11-15 21:46:16', '2024-11-15 21:46:16', 4),
(5, '0abbc32a-a39b-11ef-a437-0242ac140002', 'Hacienda Mexicana', 'Hacienda_Mexicana_612384', 'Sala inspirada en las haciendas tradicionales mexicanas, con colores vivos y detalles coloniales.', 'México', 55, 0, 0.00, '/src/assets/rooms/mexico.webp', 1, '2024-11-15 21:46:16', '2024-11-15 21:46:16', 5),
(6, '0abbc48f-a39b-11ef-a437-0242ac140002', 'Salón del Bósforo', 'Salon_del_Bosforo_781234', 'Sala con decoración otomana y vistas simuladas del estrecho del Bósforo.', 'Turquía', 65, 0, 0.00, '/src/assets/rooms/turkey.webp', 1, '2024-11-15 21:46:16', '2024-11-15 21:46:16', 6);
...
(3, '3ba1307e-b7f1-11ef-9c5f-0242ac120004', 1, 3, 0, 0.00, 'Pending', 1, '2024-12-11 18:53:38', '2024-12-11 18:53:38'),
...
INSERT INTO `Waiter` (`waiter_id`, `waiter_uuid`, `firstName`, `lastName`, `email`, `password`, `phone_number`, `hire_date`, `average_rating`, `salary`, `shift_disponibility`, `is_active`, `avatar_url`, `bio`, `created_at`, `updated_at`) VALUES
(31, 'a0b846e9-37c8-4003-8cba-a8fdd26eb421', 'Yolanda', 'Yolanda', 'yomogan@gmail.com', '$argon2i$v=19$m=65536,t=4,p=2$NHQxbmZGNlFtMGpPcHFoMQ$5ibTak/21NOtA/xFducdEjTxWZaENlAeNlJJ7j7jzrQ', NULL, '2024-12-11', 0.00, 1000.00, 'Flexible', 1, 'https://i.pravatar.cc/300?u=c064c3f90164e2848de12c6df5060e29', NULL, '2024-12-11 22:39:17', '2024-12-11 22:39:17');
...
--
ALTER TABLE `Room_Shift`
  MODIFY `room_shift_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=373;

--
-- AUTO_INCREMENT de la tabla `Shift`
--
ALTER TABLE `Shift`
  MODIFY `shift_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `Waiter`
  MODIFY `waiter_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
